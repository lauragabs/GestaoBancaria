...
public class CartaoRepository {
    ...
    public void salvar(Cartao cartao) {
        String sql = "INSERT INTO cartao (tipo_cartao, limite_cartao, data_validade_cartao, num_cartao, id_conta) VALUES (?, ?, ?, ?, ?)";
    ...
    public void atualizar(Cartao cartao) {
        String sql = "UPDATE cartao SET tipo_cartao = ?, limite_cartao = ?, data_validade_cartao = ?, num_cartao = ?, id_conta = ? WHERE id_cartao = ?";
        jdbcTemplate.update(sql, cartao.getTipoCartao(), cartao.getLimiteCartao(), cartao.getDataValidadeCartao(),
